...
def generate_Miura(n_col=n_col, n_row=n_row, l=l, w=w, a=a):
    ...
    for i_row in range(n_row):
        for i_col in range(n_col):
            ...
            i_3 = rc_2_i(i_row + 1, i_col + 1, n_row, n_col)
    ...
    return nodes, edges, faces, is_facet, is_boundary_edges, target_angles, is_boundary_nodes, nodes_prev

if __name__ == '__main__':
    nodes, edges, faces, is_facet, is_boundary_edges, target_angles, is_boundary_nodes, nodes_prev = generate_Miura()
