...
class LineMesh(object):
    ...
    def create_line_mesh(self):
        ...
        for i in range(line_segments_unit.shape[0]):
            ...
            self.line_length = line_length = line_lengths[i]
            self.axis, self.angle = axis, angle = align_vector_to_another(z_axis, line_segment)
            self.translation = translation = first_points[i, :] + line_segment * line_length * 0.5
            cylinder_segment = o3d.geometry.TriangleMesh.create_cylinder(
                self.radius, line_length, resolution=3, split=1)
